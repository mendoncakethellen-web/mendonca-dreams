...
export default function Newsletter() {
  ...
  return (
    <section id="newsletter" className="py-20 px-4 sm:px-6 lg:px-8" style={{ background: "#8B6F47" }}>
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl p-12 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="font-serif text-3xl md:text-4xl font-light" style={{ color: "#001F3F" }}>
              Fique por Dentro
            </h2>
            <p style={{ color: "#666666" }}>
              Receba as novidades, ofertas exclusivas e inspiração de moda direto no seu email
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex gap-2 max-w-md mx-auto">
            <input
              ...
              style={{ borderColor: "#e5e5e5", "--tw-ring-color": "#001F3F" } as any}
            />
            <button
              type="submit"
